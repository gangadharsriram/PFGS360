...
pip install numpy==1.26.4 matplotlib==3.7.2 evo==1.13.1 ninja pillow scikit-image scikit-learn scipy tqdm shapely colorama wheel pybind11 kornia einops timm open3d opencv-python-headless==4.10.0.84 pyproj openEXR
